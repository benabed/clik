...
component_list = ["powerlaw_free_emissivity_XX","pw_TE","pw_EE","powerlaw_free_emissivity_EE","powerlaw_free_emissivity_TE","galf_TE","galf_EE","ps_TE","ps_EE","dalf_EE","galx_EE","galx_BB","galx_TE","galx_TB","galx_EB"]
