...
def main(argv):
  ...
  lmin = nm.min([lmin143x143,lmin143x217,lmin217x217])
  lmax = nm.max([lmax143x143,lmax143x217,lmax217x217])
  ...
  lkl_grp.attrs["lmin143x143"] = lmin143x143
  lkl_grp.attrs["lmin143x217"] = lmin143x217
  lkl_grp.attrs["lmin217x217"] = lmin217x217
  lkl_grp.attrs["lmax143x143"] = lmax143x143
  lkl_grp.attrs["lmax143x217"] = lmax143x217
  lkl_grp.attrs["lmax217x217"] = lmax217x217
  lkl_grp.attrs["np143x143"]   = np143x143
  lkl_grp.attrs["np143x217"]   = np143x217
  lkl_grp.attrs["np217x217"]   = np217x217
