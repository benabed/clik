...
SRCPATHLIST := src src/minipmc src/cldf src/camspec src/bflike src/lenslike/plenslike src/cmbonly src/gibbs src/actspt src/lowlike src/plik src/plik/component_plugin/rel2015 
vpath %.c $(SRCPATHLIST)
